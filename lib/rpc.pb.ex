...
defmodule Lnrpc.SendManyRequest do
  ...
  defstruct [:AddrToAmount, :target_conf, :sat_per_byte, :label]
...
defmodule Lnrpc.SendCoinsRequest do
  ...
  defstruct [:addr, :amount, :target_conf, :sat_per_byte, :send_all, :label]
...
defmodule Lnrpc.HTLCAttempt do
  ...
  defstruct [:status, :route, :attempt_time_ns, :resolve_time_ns, :failure, :preimage]
